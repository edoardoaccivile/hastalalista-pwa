        ...
        <div className="contRegolamento">
          ...
          <div className="singleRule">
            ...
            <div className="testoRegola">
              ...
              radice della parola da far indovinare. Ogni parola indovinata vale
              1 punto.
            </div>
          </div>
          <div className="singleRule">
            ...
            <div className="testoRegola">
              ...
              qualcosa di già detto, regala 3 punti alla squadra avversaria e si
              procede all'estrazione della nuova categoria. Si gioca su 6
              categorie.
            </div>
          </div>
          <div className="singleRule">
            ...
            <div className="testoRegola">
              ...
              categorie indovinate, 10 per 5 categorie indovinate e 15 punti per
              tutte e 6 le categorie indovinate.
            </div>
          </div>
        </div>
      </div>
